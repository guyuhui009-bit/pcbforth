...
const translations: Record<string, Record<Lang, string>> = {
  ...
  // Hero
  "hero.title": { zh: "专业电子硬件开发与制造服务", en: "One-Stop Electronic Hardware Development & Manufacturing Services" },
  "hero.subtitle": { zh: "从原理图设计到PCB组装交付", en: "From Schematic Design to Fully Assembled PCB Delivery" },
  "hero.subtitle2": { zh: "提供设计、仿真、Layout、制造与SMT一站式支持", en: "Engineering • Layout • Fabrication • Assembly" },

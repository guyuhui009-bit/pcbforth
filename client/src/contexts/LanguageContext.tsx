...
const translations: Record<string, Record<Lang, string>> = {
  ...
  // Hero
  "hero.title": { zh: "精密驱动创新", en: "Precision Drives Innovation" },
  "hero.subtitle": { zh: "从原理图到成品，PCB全流程一站式服务", en: "From Schematic to Product — Full PCB One-Stop Service" },
  "hero.cta1": { zh: "立即咨询", en: "Get a Quote" },
  "hero.cta2": { zh: "查看案例", en: "View Cases" },
  "hero.stat1.num": { zh: "500+", en: "500+" },
  "hero.stat1.label": { zh: "累积客户", en: "Clients" },
  "hero.stat2.num": { zh: "15+", en: "15+" },
  "hero.stat2.label": { zh: "成立年限", en: "Years" },
  "hero.stat3.num": { zh: "50+", en: "50+" },
  "hero.stat3.label": { zh: "工程师团队", en: "Engineers" },
  "hero.stat4.num": { zh: "1000+", en: "1000+" },
  "hero.stat4.label": { zh: "完成项目", en: "Projects" },
  // About

...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "nav.schematic": { zh: "原理图设计", en: "Schematic Design" },
  "nav.layout": { zh: "PCB Layout", en: "PCB Layout" },
  "nav.bom": { zh: "元器件工程", en: "Component Engineering" },
  "nav.simulation": { zh: "仿真验证", en: "Simulation & Verification" },
  "nav.fabrication": { zh: "PCB制造", en: "PCB Fabrication" },
  "nav.smt": { zh: "SMT组装", en: "SMT Assembly" },
  "nav.cases": { zh: "合作案例", en: "Cases" },
  "nav.news": { zh: "资讯动态", en: "News" },
  "nav.contact": { zh: "联系我们", en: "Contact" },
  // Hero
  "hero.title": { zh: "将您的电子创意变成可量产产品", en: "Turn Your Electronic Ideas Into Production-Ready Hardware" },
  "hero.subtitle": { zh: "原理图设计、PCB Layout、元器件工程、PCB制造与SMT组装一站式服务", en: "Schematic Design, PCB Layout, Component Engineering, PCB Fabrication and SMT Assembly Services" },
  "hero.subtitle2": { zh: "从概念到量产，全流程工程支持", en: "From Concept to Mass Production, Full-Cycle Engineering Support" },
  "hero.badge": { zh: "PCBforth Technology", en: "PCBforth Technology" },
  "hero.cta1": { zh: "免费工程评审", en: "Get Free Engineering Review" },
  "hero.cta2": { zh: "上传设计文件", en: "Upload Your Files" },
  "hero.tag1": { zh: "原理图设计", en: "Schematic Design" },
  "hero.tag2": { zh: "PCB Layout", en: "PCB Layout" },
  "hero.tag3": { zh: "PCB制造", en: "PCB Fabrication" },
  "hero.tag4": { zh: "SMT组装", en: "SMT Assembly" },
  ...
  // Schematic
  "schematic.title": { zh: "原理图设计", en: "Schematic Design" },
  ...
  // BOM
  "bom.title": { zh: "元器件工程", en: "Component Engineering" },
  "bom.desc": { zh: "PCBforth元器件工程团队具备深度的全球供应商资源与器件选型经验，为客户提供元器件选型、替代料方案、供应链风险评估与成本优化等全面服务。无论是应对缺货、降低物料成本，还是确保器件在全生命周期稳定供货，我们都能提供专业工程建议，帮助客户降低供应链风险。", en: "PCBforth's Component Engineering team brings deep expertise in global supplier networks and component selection. We provide comprehensive services including component selection, alternative sourcing, supply chain risk assessment, and cost optimization. Whether addressing component shortages, reducing BOM costs, or ensuring long-term supply stability, our engineers deliver professional recommendations to minimize your supply chain risks." },
  ...
  // Simulation
  "simulation.title": { zh: "仿真验证", en: "Simulation & Verification" },
  ...
  // SMT
  "smt.title": { zh: "SMT组装", en: "SMT Assembly" },

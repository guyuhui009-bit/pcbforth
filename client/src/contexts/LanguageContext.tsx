...
const translations: Record<string, Record<Lang, string>> = {
  ...
  // Hero
  "hero.title": { zh: "专业PCB设计与硬件工程服务", en: "Professional PCB Design & Hardware Engineering Services" },
  "hero.subtitle": { zh: "原理图设计 · PCB Layout · 元器件选型 · 仿真分析 · 制造支持", en: "Schematic Design · PCB Layout · Component Selection · Simulation · Manufacturing Support" },
  "hero.subtitle2": { zh: "从概念到量产，全流程工程支持", en: "From Concept to Production" },
  ...
  "hero.tag4": { zh: "仿真分析", en: "Simulation" },
  "hero.tag5": { zh: "制造支持", en: "Manufacturing Support" },
